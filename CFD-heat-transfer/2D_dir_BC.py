...
# program for pure dirichlets BC
print("\n")
...
south = int(input("value of temperature at south end  "))
...
arr[c][0] = (south + west) / 2
arr[0][d] = (north + east) / 2
arr[c][d] = (south + east) / 2

guess = (north + south + east + west) / 4
...
print("initial matrix without any iterations : ", arr)
...
while (
    ...
    cnt = 0
    for g in range(1, c):  # comapring (k) and (k+1)th values with allowable error value
        for h in range(1, d):
